...
CREATE TABLE `project_detail` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `project_detail_ibfk_1` FOREIGN KEY (`id_project`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
  CONSTRAINT `project_detail_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
INSERT INTO `project_detail` VALUES (1,1,1),(2,2,2),(4,4,1),(5,5,2),(7,2,1);
