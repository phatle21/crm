...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<%=contextPath%>/plugins/images/favicon.png">
    <title>403 - Forbidden</title>
    <!-- Bootstrap Core CSS -->
    <link href='<%=contextPath%>/bootstrap/dist/css/bootstrap.min.css' rel="stylesheet">
    <!-- animation CSS -->
    <link href='<%=contextPath%>/css/animate.css' rel="stylesheet">
    <!-- Custom CSS -->
    <link href='<%=contextPath%>/css/style.css' rel="stylesheet">
    <!-- color CSS -->
    <link href='<%=contextPath%>/css/colors/blue.css' id="theme" rel="stylesheet">
</head>
