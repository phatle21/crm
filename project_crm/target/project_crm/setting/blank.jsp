    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg "
                ...
                <div class="top-left-part"><a class="logo" href="../home/index.jsp"><b><img
            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;">
                        <a href="../home/index.jsp" class="waves-effect"><i class="fa fa-clock-o fa-fw"
                    ...
                    <li>
                        <a href="groupwork-table.jsp" class="waves-effect"><i class="fa fa-table fa-fw"
